...
public class MainController {
	...
	@GetMapping("/")
	public String mainPage(@RequestParam(name = "cityName", required = false, defaultValue = "서울") String cityName,
		...
		//-> charset=UTF-8을 추가하여 응답 데이터의 문자 인코등을 UTF-8로 지정
		// --> 한글 깨짐 해결
		...
		// spring-starter-web dependency에 Jackson data-bind 포함되어있음
	 ...
	 * 
	 * - HTTP 응답을 표현할 수 있는 객체 - 비동기 응답 서비스(RESTful API)에서 유용하게 사용
	 */
	...
	*/
	...
	String serviceKey = "rzVwUIadgYQmA2DSUZLzfBwzTBfoAmLBrdTba32C8oI%2F3xiNJCAIwBj4OGxKHp7g6TLYb0unZDDntjPYXu%2BYIA%3D%3D";
